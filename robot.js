...
export class Robot {
    ...
    constructor(world, scene) {
        ...
        let arm_w = 0.05;
        this.base = utils.addBody("position", "cuboid", world, scene, 0, 0, -1, r_d, 0.4, 0.15, 0.4);
        this.mast = utils.addBody("dynamic", "cuboid", world, this.base.m, 0, 0, -1, r_d, 0.075, 1.5, 0.075);
